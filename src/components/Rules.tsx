...
const Rules: FC = () => {
	const { hideModal } = useStore((state) => state);
	return (
		<motion.div
			initial={{ opacity: 0 }}
			animate={{ opacity: 1 }}
			...
			className="fixed overflow-hidden w-full h-full z-20 bg-white sm:bg-black/50 fc"
		>
			<div className="p-10 m-5 bg-white rounded-2xl relative gap-5 fc">
				...
				<svg xmlns="http://www.w3.org/2000/svg" width="304" height="270">
					...
					<g fill="none" fill-rule="evenodd">
						...
						<text fill="#B1B4C5" className="font-barlow" font-size="13" font-weight="bold">
							<tspan x="134" y="31">
								BEATS
							</tspan>
						</text>
			...
			<div onClick={hideModal} className="absolute w-screen hidden sm:block h-screen" />
		</motion.div>
	);
};
